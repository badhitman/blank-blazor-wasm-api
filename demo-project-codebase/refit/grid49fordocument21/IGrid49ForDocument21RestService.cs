...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid49ForDocument21RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '21'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid49ForDocument21 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '21'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid49ForDocument21> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid49ForDocument21 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '21'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid49ForDocument21> objects_range_rest_upd);
