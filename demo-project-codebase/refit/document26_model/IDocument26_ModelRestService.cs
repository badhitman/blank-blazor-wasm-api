...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument26_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '26'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document26_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '26'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document26_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document26_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '26'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document26_Model> objects_range_rest_upd);
