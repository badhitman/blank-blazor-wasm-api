...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid92ForDocument39RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '39'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid92ForDocument39 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '39'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid92ForDocument39> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid92ForDocument39 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '39'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid92ForDocument39> objects_range_rest_upd);
