...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid220ForDocument87RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '87'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid220ForDocument87 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '87'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid220ForDocument87> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid220ForDocument87 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '87'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid220ForDocument87> objects_range_rest_upd);
