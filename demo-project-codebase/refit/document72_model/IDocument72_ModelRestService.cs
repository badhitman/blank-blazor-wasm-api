...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument72_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '72'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document72_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '72'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document72_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document72_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '72'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document72_Model> objects_range_rest_upd);
