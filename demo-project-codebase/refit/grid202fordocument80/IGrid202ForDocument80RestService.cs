...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid202ForDocument80RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '80'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid202ForDocument80 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '80'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid202ForDocument80> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid202ForDocument80 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '80'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid202ForDocument80> objects_range_rest_upd);
