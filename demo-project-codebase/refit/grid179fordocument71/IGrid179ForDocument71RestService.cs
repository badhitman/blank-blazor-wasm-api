...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid179ForDocument71RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '71'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid179ForDocument71 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '71'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid179ForDocument71> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid179ForDocument71 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '71'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid179ForDocument71> objects_range_rest_upd);
