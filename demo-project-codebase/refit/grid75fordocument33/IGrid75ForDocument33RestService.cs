...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid75ForDocument33RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '33'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid75ForDocument33 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '33'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid75ForDocument33> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid75ForDocument33 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '33'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid75ForDocument33> objects_range_rest_upd);
