...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid62ForDocument27RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '27'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid62ForDocument27 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '27'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid62ForDocument27> objects_range_rest);

		/// <summary>
		/// Получить документ по идентификатору: Document name '27'
		/// </summary>
		public Task<Grid62ForDocument27_ResponseModel> FirstAsync(int id);

		/// <summary>
		/// Получить коллекцию документов по идентификаторам: Document name '27'
		/// </summary>
		public Task<Grid62ForDocument27_ResponseListModel> SelectAsync(IEnumerable<int> ids);

		/// <summary>
		/// Получить порцию (пагинатор) строк табличной части документа по идентификатору документа: Document name '27'
		/// </summary>
		public Task<Grid62ForDocument27_ResponsePaginationModel> SelectAsync(GetByIdPaginationRequestModel request);

		/// <summary>
		/// Обновить документ в БД: Document name '27'
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid62ForDocument27 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '27'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid62ForDocument27> objects_range_rest_upd);
