...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid214ForDocument84RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '84'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid214ForDocument84 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '84'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid214ForDocument84> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid214ForDocument84 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '84'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid214ForDocument84> objects_range_rest_upd);
