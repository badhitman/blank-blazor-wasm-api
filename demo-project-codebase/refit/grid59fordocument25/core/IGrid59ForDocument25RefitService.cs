...
namespace Test2.DemoNameSpace
{
	...
	public interface IGrid59ForDocument25RefitService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '25'
		/// </summary>
		[Post($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.AddSingle)}")]
		...
		/// </summary>
		[Post($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.AddRange)}")]
		...
		/// </summary>
		[Get($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.GetSingleById)}/{{id}}")]
		...
		/// </summary>
		[Get($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.GetRangeByIds)}")]
		...
		/// </summary>
		[Get($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.GetRangeByOwnerId)}")]
		...
		/// </summary>
		[Put($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.UpdateSingle)}")]
		...
		/// </summary>
		[Put($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.UpdateRange)}")]
		...
		/// </summary>
		[Patch($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.MarkAsDeleteById)}")]
		public Task<ApiResponse<ResponseBaseModel>> MarkDeleteToggleAsync(int id);

		/// <summary>
		/// Удалить документ из БД по идентификатору: Document name '25'
		/// </summary>
		[Delete($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.RemoveSingleById)}")]
		public Task<ApiResponse<ResponseBaseModel>> RemoveAsync(int id);

		/// <summary>
		/// Удалить документы из БД по идентификаторам: Document name '25'
		/// </summary>
		[Delete($"/api/grid59fordocument25/{nameof(RouteMethodsPrefixesEnum.RemoveRangeByIds)}")]
