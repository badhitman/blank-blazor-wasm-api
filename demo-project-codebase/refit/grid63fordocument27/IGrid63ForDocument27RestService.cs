...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid63ForDocument27RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '27'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid63ForDocument27 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '27'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid63ForDocument27> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid63ForDocument27 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '27'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid63ForDocument27> objects_range_rest_upd);
