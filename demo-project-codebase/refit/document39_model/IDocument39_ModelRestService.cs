...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument39_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '39'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document39_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '39'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document39_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document39_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '39'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document39_Model> objects_range_rest_upd);
