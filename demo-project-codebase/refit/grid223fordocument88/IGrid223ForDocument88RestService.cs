...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid223ForDocument88RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '88'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid223ForDocument88 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '88'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid223ForDocument88> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid223ForDocument88 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '88'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid223ForDocument88> objects_range_rest_upd);
