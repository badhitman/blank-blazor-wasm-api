...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument18_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '18'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document18_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '18'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document18_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document18_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '18'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document18_Model> objects_range_rest_upd);
