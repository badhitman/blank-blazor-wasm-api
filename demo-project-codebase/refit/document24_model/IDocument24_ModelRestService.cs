...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument24_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '24'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document24_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '24'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document24_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document24_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '24'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document24_Model> objects_range_rest_upd);
