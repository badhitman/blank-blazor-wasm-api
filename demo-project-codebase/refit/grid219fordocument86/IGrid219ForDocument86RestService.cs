...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid219ForDocument86RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '86'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid219ForDocument86 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '86'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid219ForDocument86> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid219ForDocument86 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '86'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid219ForDocument86> objects_range_rest_upd);
