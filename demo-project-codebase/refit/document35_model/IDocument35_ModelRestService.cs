...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument35_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '35'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document35_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '35'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document35_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document35_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '35'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document35_Model> objects_range_rest_upd);
