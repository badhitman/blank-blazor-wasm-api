...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid100ForDocument42RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '42'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid100ForDocument42 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '42'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid100ForDocument42> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid100ForDocument42 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '42'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid100ForDocument42> objects_range_rest_upd);
