...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument25_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '25'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document25_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '25'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document25_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document25_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '25'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document25_Model> objects_range_rest_upd);
