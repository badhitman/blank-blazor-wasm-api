...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid103ForDocument44RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '44'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid103ForDocument44 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '44'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid103ForDocument44> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid103ForDocument44 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '44'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid103ForDocument44> objects_range_rest_upd);
