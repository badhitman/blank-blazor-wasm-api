...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid88ForDocument38RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '38'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid88ForDocument38 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '38'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid88ForDocument38> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid88ForDocument38 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '38'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid88ForDocument38> objects_range_rest_upd);
