...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument27_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '27'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document27_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '27'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document27_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document27_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '27'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document27_Model> objects_range_rest_upd);
