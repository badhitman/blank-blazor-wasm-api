...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid115ForDocument49RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '49'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid115ForDocument49 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '49'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid115ForDocument49> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid115ForDocument49 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '49'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid115ForDocument49> objects_range_rest_upd);
