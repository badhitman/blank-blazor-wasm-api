...
namespace Test2.DemoNameSpace
{
	...
	public interface IGrid115ForDocument49RefitService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '49'
		/// </summary>
		[Post($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.AddSingle)}")]
		...
		/// </summary>
		[Post($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.AddRange)}")]
		...
		/// </summary>
		[Get($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.GetSingleById)}/{{id}}")]
		...
		/// </summary>
		[Get($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.GetRangeByIds)}")]
		...
		/// </summary>
		[Get($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.GetRangeByOwnerId)}")]
		...
		/// </summary>
		[Put($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.UpdateSingle)}")]
		...
		/// </summary>
		[Put($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.UpdateRange)}")]
		...
		/// </summary>
		[Patch($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.MarkAsDeleteById)}")]
		public Task<ApiResponse<ResponseBaseModel>> MarkDeleteToggleAsync(int id);

		/// <summary>
		/// Удалить документ из БД по идентификатору: Document name '49'
		/// </summary>
		[Delete($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.RemoveSingleById)}")]
		public Task<ApiResponse<ResponseBaseModel>> RemoveAsync(int id);

		/// <summary>
		/// Удалить документы из БД по идентификаторам: Document name '49'
		/// </summary>
		[Delete($"/api/grid115fordocument49/{nameof(RouteMethodsPrefixesEnum.RemoveRangeByIds)}")]
