...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid190ForDocument75RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '75'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid190ForDocument75 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '75'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid190ForDocument75> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid190ForDocument75 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '75'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid190ForDocument75> objects_range_rest_upd);
