...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument49_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '49'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document49_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '49'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document49_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document49_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '49'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document49_Model> objects_range_rest_upd);
