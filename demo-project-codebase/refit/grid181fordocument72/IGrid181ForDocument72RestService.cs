...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid181ForDocument72RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '72'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid181ForDocument72 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '72'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid181ForDocument72> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid181ForDocument72 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '72'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid181ForDocument72> objects_range_rest_upd);
