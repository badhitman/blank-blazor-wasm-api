...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid200ForDocument79RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '79'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid200ForDocument79 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '79'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid200ForDocument79> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid200ForDocument79 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '79'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid200ForDocument79> objects_range_rest_upd);
