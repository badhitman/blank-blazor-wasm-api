...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument79_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '79'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document79_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '79'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document79_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document79_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '79'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document79_Model> objects_range_rest_upd);
