...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument88_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '88'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document88_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '88'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document88_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document88_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '88'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document88_Model> objects_range_rest_upd);
