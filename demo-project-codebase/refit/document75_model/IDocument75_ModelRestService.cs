...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument75_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '75'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document75_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '75'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document75_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document75_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '75'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document75_Model> objects_range_rest_upd);
