...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid60ForDocument26RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '26'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid60ForDocument26 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '26'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid60ForDocument26> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid60ForDocument26 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '26'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid60ForDocument26> objects_range_rest_upd);
