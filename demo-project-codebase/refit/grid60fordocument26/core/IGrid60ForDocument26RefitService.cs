...
namespace Test2.DemoNameSpace
{
	...
	public interface IGrid60ForDocument26RefitService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '26'
		/// </summary>
		[Post($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.AddSingle)}")]
		...
		/// </summary>
		[Post($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.AddRange)}")]
		...
		/// </summary>
		[Get($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.GetSingleById)}/{{id}}")]
		...
		/// </summary>
		[Get($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.GetRangeByIds)}")]
		...
		/// </summary>
		[Get($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.GetRangeByOwnerId)}")]
		...
		/// </summary>
		[Put($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.UpdateSingle)}")]
		...
		/// </summary>
		[Put($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.UpdateRange)}")]
		...
		/// </summary>
		[Patch($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.MarkAsDeleteById)}")]
		public Task<ApiResponse<ResponseBaseModel>> MarkDeleteToggleAsync(int id);

		/// <summary>
		/// Удалить документ из БД по идентификатору: Document name '26'
		/// </summary>
		[Delete($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.RemoveSingleById)}")]
		public Task<ApiResponse<ResponseBaseModel>> RemoveAsync(int id);

		/// <summary>
		/// Удалить документы из БД по идентификаторам: Document name '26'
		/// </summary>
		[Delete($"/api/grid60fordocument26/{nameof(RouteMethodsPrefixesEnum.RemoveRangeByIds)}")]
