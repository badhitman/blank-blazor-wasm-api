...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument31_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '31'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document31_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '31'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document31_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document31_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '31'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document31_Model> objects_range_rest_upd);
