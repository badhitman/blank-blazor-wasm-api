...
namespace Test4.DemoNameSpace
{
	...
	public interface IGrid212ForDocument84RefitService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '84'
		/// </summary>
		[Post($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.AddSingle)}")]
		...
		/// </summary>
		[Post($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.AddRange)}")]
		...
		/// </summary>
		[Get($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.GetSingleById)}/{{id}}")]
		...
		/// </summary>
		[Get($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.GetRangeByIds)}")]
		...
		/// </summary>
		[Get($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.GetRangeByOwnerId)}")]
		...
		/// </summary>
		[Put($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.UpdateSingle)}")]
		...
		/// </summary>
		[Put($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.UpdateRange)}")]
		...
		/// </summary>
		[Patch($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.MarkAsDeleteById)}")]
		public Task<ApiResponse<ResponseBaseModel>> MarkDeleteToggleAsync(int id);

		/// <summary>
		/// Удалить документ из БД по идентификатору: Document name '84'
		/// </summary>
		[Delete($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.RemoveSingleById)}")]
		public Task<ApiResponse<ResponseBaseModel>> RemoveAsync(int id);

		/// <summary>
		/// Удалить документы из БД по идентификаторам: Document name '84'
		/// </summary>
		[Delete($"/api/grid212fordocument84/{nameof(RouteMethodsPrefixesEnum.RemoveRangeByIds)}")]
