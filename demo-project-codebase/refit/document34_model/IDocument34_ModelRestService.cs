...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument34_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '34'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document34_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '34'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document34_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document34_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '34'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document34_Model> objects_range_rest_upd);
