...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid84ForDocument36RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '36'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid84ForDocument36 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '36'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid84ForDocument36> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid84ForDocument36 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '36'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid84ForDocument36> objects_range_rest_upd);
