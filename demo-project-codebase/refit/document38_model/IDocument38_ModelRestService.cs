...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument38_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '38'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document38_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '38'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document38_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document38_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '38'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document38_Model> objects_range_rest_upd);
