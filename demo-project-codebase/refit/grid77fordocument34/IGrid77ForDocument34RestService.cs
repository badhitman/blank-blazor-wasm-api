...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid77ForDocument34RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '34'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid77ForDocument34 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '34'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid77ForDocument34> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid77ForDocument34 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '34'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid77ForDocument34> objects_range_rest_upd);
