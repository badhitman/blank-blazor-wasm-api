...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid193ForDocument76RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '76'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid193ForDocument76 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '76'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid193ForDocument76> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid193ForDocument76 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '76'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid193ForDocument76> objects_range_rest_upd);
