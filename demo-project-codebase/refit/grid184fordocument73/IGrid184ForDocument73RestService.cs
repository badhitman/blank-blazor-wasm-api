...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid184ForDocument73RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '73'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid184ForDocument73 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '73'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid184ForDocument73> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid184ForDocument73 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '73'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid184ForDocument73> objects_range_rest_upd);
