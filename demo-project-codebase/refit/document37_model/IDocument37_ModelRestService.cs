...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument37_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '37'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document37_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '37'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document37_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document37_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '37'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document37_Model> objects_range_rest_upd);
