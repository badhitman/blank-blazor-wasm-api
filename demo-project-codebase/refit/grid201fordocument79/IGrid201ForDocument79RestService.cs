...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid201ForDocument79RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '79'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid201ForDocument79 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '79'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid201ForDocument79> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid201ForDocument79 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '79'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid201ForDocument79> objects_range_rest_upd);
