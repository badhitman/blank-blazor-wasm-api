...
namespace Test4.DemoNameSpace
{
	...
	public interface IGrid201ForDocument79RefitService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '79'
		/// </summary>
		[Post($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.AddSingle)}")]
		...
		/// </summary>
		[Post($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.AddRange)}")]
		...
		/// </summary>
		[Get($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.GetSingleById)}/{{id}}")]
		...
		/// </summary>
		[Get($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.GetRangeByIds)}")]
		...
		/// </summary>
		[Get($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.GetRangeByOwnerId)}")]
		...
		/// </summary>
		[Put($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.UpdateSingle)}")]
		...
		/// </summary>
		[Put($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.UpdateRange)}")]
		...
		/// </summary>
		[Patch($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.MarkAsDeleteById)}")]
		public Task<ApiResponse<ResponseBaseModel>> MarkDeleteToggleAsync(int id);

		/// <summary>
		/// Удалить документ из БД по идентификатору: Document name '79'
		/// </summary>
		[Delete($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.RemoveSingleById)}")]
		public Task<ApiResponse<ResponseBaseModel>> RemoveAsync(int id);

		/// <summary>
		/// Удалить документы из БД по идентификаторам: Document name '79'
		/// </summary>
		[Delete($"/api/grid201fordocument79/{nameof(RouteMethodsPrefixesEnum.RemoveRangeByIds)}")]
