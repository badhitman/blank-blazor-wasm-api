...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid188ForDocument75RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '75'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid188ForDocument75 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '75'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid188ForDocument75> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid188ForDocument75 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '75'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid188ForDocument75> objects_range_rest_upd);
