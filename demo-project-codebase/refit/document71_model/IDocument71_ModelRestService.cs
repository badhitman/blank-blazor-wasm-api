...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument71_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '71'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document71_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '71'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document71_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document71_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '71'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document71_Model> objects_range_rest_upd);
