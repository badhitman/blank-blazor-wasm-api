...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid183ForDocument72RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '72'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid183ForDocument72 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '72'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid183ForDocument72> objects_range_rest);

		/// <summary>
		/// Получить документ по идентификатору: Document name '72'
		/// </summary>
		public Task<Grid183ForDocument72_ResponseModel> FirstAsync(int id);

		/// <summary>
		/// Получить коллекцию документов по идентификаторам: Document name '72'
		/// </summary>
		public Task<Grid183ForDocument72_ResponseListModel> SelectAsync(IEnumerable<int> ids);

		/// <summary>
		/// Получить порцию (пагинатор) строк табличной части документа по идентификатору документа: Document name '72'
		/// </summary>
		public Task<Grid183ForDocument72_ResponsePaginationModel> SelectAsync(GetByIdPaginationRequestModel request);

		/// <summary>
		/// Обновить документ в БД: Document name '72'
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid183ForDocument72 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '72'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid183ForDocument72> objects_range_rest_upd);
