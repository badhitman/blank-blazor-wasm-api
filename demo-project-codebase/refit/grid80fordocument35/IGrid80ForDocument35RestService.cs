...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid80ForDocument35RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '35'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid80ForDocument35 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '35'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid80ForDocument35> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid80ForDocument35 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '35'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid80ForDocument35> objects_range_rest_upd);
