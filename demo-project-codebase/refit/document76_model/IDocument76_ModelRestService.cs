...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument76_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '76'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document76_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '76'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document76_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document76_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '76'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document76_Model> objects_range_rest_upd);
