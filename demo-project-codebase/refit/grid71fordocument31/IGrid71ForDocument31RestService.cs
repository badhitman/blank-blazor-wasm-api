...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid71ForDocument31RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '31'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid71ForDocument31 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '31'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid71ForDocument31> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid71ForDocument31 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '31'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid71ForDocument31> objects_range_rest_upd);
