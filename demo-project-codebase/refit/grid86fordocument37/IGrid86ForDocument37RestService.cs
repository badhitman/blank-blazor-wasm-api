...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid86ForDocument37RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '37'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid86ForDocument37 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '37'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid86ForDocument37> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid86ForDocument37 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '37'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid86ForDocument37> objects_range_rest_upd);
