...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument73_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '73'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document73_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '73'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document73_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document73_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '73'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document73_Model> objects_range_rest_upd);
