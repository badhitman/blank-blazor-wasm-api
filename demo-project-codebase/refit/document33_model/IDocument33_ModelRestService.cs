...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument33_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '33'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document33_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '33'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document33_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document33_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '33'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document33_Model> objects_range_rest_upd);
