...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid58ForDocument25RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '25'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid58ForDocument25 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '25'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid58ForDocument25> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid58ForDocument25 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '25'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid58ForDocument25> objects_range_rest_upd);
