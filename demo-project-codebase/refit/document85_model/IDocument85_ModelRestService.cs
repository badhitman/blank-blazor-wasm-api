...
namespace Test4.DemoNameSpace
{
	...
	/// </summary>
	public interface IDocument85_ModelRestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '85'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Document85_Model object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '85'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Document85_Model> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Document85_Model object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '85'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document85_Model> objects_range_rest_upd);
