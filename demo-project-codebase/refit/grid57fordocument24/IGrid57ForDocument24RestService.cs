...
namespace Test2.DemoNameSpace
{
	...
	/// </summary>
	public interface IGrid57ForDocument24RestService
	{
		/// <summary>
		/// Добавить документ в БД: Document name '24'
		/// </summary>
		public Task<IdResponseModel> AddAsync(Grid57ForDocument24 object_rest);

		/// <summary>
		/// Добавить набор документов в БД: Document name '24'
		/// </summary>
		public Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid57ForDocument24> objects_range_rest);
		...
		/// </summary>
		public Task<ResponseBaseModel> UpdateAsync(Grid57ForDocument24 object_rest_upd);

		/// <summary>
		/// Обновить коллекцию документов в БД: Document name '24'
		/// </summary>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid57ForDocument24> objects_range_rest_upd);
