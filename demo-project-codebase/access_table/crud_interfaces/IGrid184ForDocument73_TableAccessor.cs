...
{
	/// <summary>
	/// Табличная часть документа: Document grid name '184'
	/// </summary>
	public partial interface IGrid184ForDocument73_TableAccessor : SharedLib.ISavingChanges
	{
		/// <summary>
		...
		public Task AddAsync(Grid184ForDocument73 obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task AddRangeAsync(IEnumerable<Grid184ForDocument73> obj_rest_range, bool auto_save = true);

		/// <summary>
		/// Прочитать строку табличной части документа: Document grid name '184'
		/// </summary>
		/// <param name="id">Идентификатор объекта</param>
		public Task<Grid184ForDocument73?> FirstAsync(int id);

		/// <summary>
		/// Получить (набор) строк табличной части документов: Document grid name '184'
		/// </summary>
		/// <param name="ids">Идентификаторы объектов</param>
		public Task<IEnumerable<Grid184ForDocument73>> SelectAsync(IEnumerable<int> ids);
		...
		public Task<Grid184ForDocument73_ResponsePaginationModel> SelectAsync(GetByIdPaginationRequestModel pagination_request);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateAsync(Grid184ForDocument73 obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateRangeAsync(IEnumerable<Grid184ForDocument73> obj_rest_range, bool auto_save = true);
