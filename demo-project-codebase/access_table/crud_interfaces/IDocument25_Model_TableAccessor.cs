...
namespace Test2.DemoNameSpace
{
	...
	/// Document name '25'
	/// </summary>
	public partial interface IDocument25_Model_TableAccessor : SharedLib.ISavingChanges
	{
		/// <summary>
		...
		public Task AddAsync(Document25_Model obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task AddRangeAsync(IEnumerable<Document25_Model> obj_rest_range, bool auto_save = true);

		/// <summary>
		/// Прочитать документ: Document name '25'
		/// </summary>
		/// <param name="id">Идентификатор объекта</param>
		public Task<Document25_Model?> FirstAsync(int id);

		/// <summary>
		/// Получить (набор) документов: Document name '25'
		/// </summary>
		/// <param name="ids">Идентификаторы объектов</param>
		public Task<IEnumerable<Document25_Model>> SelectAsync(IEnumerable<int> ids);

		/// <summary>
		/// Получить (страницу) документов: Document name '25'
		/// </summary>
		/// <param name="pagination_request">Запрос-пагинатор</param>
		public Task<Document25_Model_ResponsePaginationModel> SelectAsync(PaginationRequestModel pagination_request);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateAsync(Document25_Model obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateRangeAsync(IEnumerable<Document25_Model> obj_rest_range, bool auto_save = true);
