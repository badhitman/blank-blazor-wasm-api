...
{
	/// <summary>
	/// Табличная часть документа: Document grid name '218'
	/// </summary>
	public partial interface IGrid218ForDocument86_TableAccessor : SharedLib.ISavingChanges
	{
		/// <summary>
		...
		public Task AddAsync(Grid218ForDocument86 obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task AddRangeAsync(IEnumerable<Grid218ForDocument86> obj_rest_range, bool auto_save = true);

		/// <summary>
		/// Прочитать строку табличной части документа: Document grid name '218'
		/// </summary>
		/// <param name="id">Идентификатор объекта</param>
		public Task<Grid218ForDocument86?> FirstAsync(int id);

		/// <summary>
		/// Получить (набор) строк табличной части документов: Document grid name '218'
		/// </summary>
		/// <param name="ids">Идентификаторы объектов</param>
		public Task<IEnumerable<Grid218ForDocument86>> SelectAsync(IEnumerable<int> ids);
		...
		public Task<Grid218ForDocument86_ResponsePaginationModel> SelectAsync(GetByIdPaginationRequestModel pagination_request);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateAsync(Grid218ForDocument86 obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateRangeAsync(IEnumerable<Grid218ForDocument86> obj_rest_range, bool auto_save = true);
