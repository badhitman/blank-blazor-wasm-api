...
{
	/// <summary>
	/// Табличная часть документа: Document grid name '213'
	/// </summary>
	public partial interface IGrid213ForDocument84_TableAccessor : SharedLib.ISavingChanges
	{
		/// <summary>
		...
		public Task AddAsync(Grid213ForDocument84 obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task AddRangeAsync(IEnumerable<Grid213ForDocument84> obj_rest_range, bool auto_save = true);

		/// <summary>
		/// Прочитать строку табличной части документа: Document grid name '213'
		/// </summary>
		/// <param name="id">Идентификатор объекта</param>
		public Task<Grid213ForDocument84?> FirstAsync(int id);

		/// <summary>
		/// Получить (набор) строк табличной части документов: Document grid name '213'
		/// </summary>
		/// <param name="ids">Идентификаторы объектов</param>
		public Task<IEnumerable<Grid213ForDocument84>> SelectAsync(IEnumerable<int> ids);
		...
		public Task<Grid213ForDocument84_ResponsePaginationModel> SelectAsync(GetByIdPaginationRequestModel pagination_request);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateAsync(Grid213ForDocument84 obj_rest, bool auto_save = true);
		...
		/// <param name="auto_save">Автоматически/сразу сохранить изменения в БД</param>
		public Task UpdateRangeAsync(IEnumerable<Grid213ForDocument84> obj_rest_range, bool auto_save = true);
