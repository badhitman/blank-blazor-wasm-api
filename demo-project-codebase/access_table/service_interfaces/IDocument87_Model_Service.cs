...
namespace Test4.DemoNameSpace
{
	...
	public partial interface IDocument87_Model_Service
	{
		...
		/// <summary>
		/// Получить (набор) строк табличной части документа: Document name '87'
		/// </summary>
		...
		public Task<ResponseBaseModel> UpdateAsync(Document87_Model obj_rest);

		/// <summary>
		/// Обновить перечень объектов/документов: Document name '87'
		/// </summary>
		/// <param name="obj_range_rest">Объекты обновления в БД</param>
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Document87_Model> obj_range_rest);
