...
{
	/// <summary>
	/// Document grid name '79'
	/// </summary>
	public partial interface IGrid79ForDocument34_Service
	{
		/// <summary>
		...
		public Task<IdResponseModel> AddAsync(Grid79ForDocument34 obj_rest);
		...
		public Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid79ForDocument34> obj_range_rest);
