...
{
	/// <inheritdoc/>
	public partial class Grid44ForDocument18_Service : IGrid44ForDocument18_Service
	{
		readonly IGrid44ForDocument18_TableAccessor _crud_accessor;

		/// <summary>
		/// Конструктор
		/// </summary>
		public Grid44ForDocument18_Service(IGrid44ForDocument18_TableAccessor set_crud_accessor)
		{
			_crud_accessor = set_crud_accessor;
		}

		/// <inheritdoc/>
		public async Task<IdResponseModel> AddAsync(Grid44ForDocument18 obj_rest)
		{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid44ForDocument18> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid44ForDocument18_ResponseModel result = new() { IsSuccess = true };
			try
			{
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid44ForDocument18_ResponseListModel result = new() { IsSuccess = true };
			try
			{
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid44ForDocument18_ResponsePaginationModel result = new() { IsSuccess = true };
			try
			{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateAsync(Grid44ForDocument18 obj_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid44ForDocument18> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
