...
{
	/// <inheritdoc/>
	public partial class Grid84ForDocument36_Service : IGrid84ForDocument36_Service
	{
		readonly IGrid84ForDocument36_TableAccessor _crud_accessor;

		/// <summary>
		/// Конструктор
		/// </summary>
		public Grid84ForDocument36_Service(IGrid84ForDocument36_TableAccessor set_crud_accessor)
		{
			_crud_accessor = set_crud_accessor;
		}

		/// <inheritdoc/>
		public async Task<IdResponseModel> AddAsync(Grid84ForDocument36 obj_rest)
		{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid84ForDocument36> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
		...
		/// <inheritdoc/>
		public async Task<Grid84ForDocument36_ResponseModel?> FirstAsync(int id)
		{
			//// TODO: Проверить сгенерированный код
			Grid84ForDocument36_ResponseModel result = new() { IsSuccess = true };
			try
			{
		...
		/// <inheritdoc/>
		public async Task<Grid84ForDocument36_ResponseListModel> SelectAsync(IEnumerable<int> ids)
		{
			//// TODO: Проверить сгенерированный код
			Grid84ForDocument36_ResponseListModel result = new() { IsSuccess = true };
			try
			{
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid84ForDocument36_ResponsePaginationModel result = new() { IsSuccess = true };
			try
			{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateAsync(Grid84ForDocument36 obj_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid84ForDocument36> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
