...
{
	/// <inheritdoc/>
	public partial class Grid55ForDocument24_Service : IGrid55ForDocument24_Service
	{
		readonly IGrid55ForDocument24_TableAccessor _crud_accessor;

		/// <summary>
		/// Конструктор
		/// </summary>
		public Grid55ForDocument24_Service(IGrid55ForDocument24_TableAccessor set_crud_accessor)
		{
			_crud_accessor = set_crud_accessor;
		}

		/// <inheritdoc/>
		public async Task<IdResponseModel> AddAsync(Grid55ForDocument24 obj_rest)
		{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid55ForDocument24> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid55ForDocument24_ResponseModel result = new() { IsSuccess = true };
			try
			{
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid55ForDocument24_ResponseListModel result = new() { IsSuccess = true };
			try
			{
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid55ForDocument24_ResponsePaginationModel result = new() { IsSuccess = true };
			try
			{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateAsync(Grid55ForDocument24 obj_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid55ForDocument24> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
