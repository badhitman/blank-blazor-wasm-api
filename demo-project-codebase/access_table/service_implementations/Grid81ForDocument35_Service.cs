...
{
	/// <inheritdoc/>
	public partial class Grid81ForDocument35_Service : IGrid81ForDocument35_Service
	{
		readonly IGrid81ForDocument35_TableAccessor _crud_accessor;

		/// <summary>
		/// Конструктор
		/// </summary>
		public Grid81ForDocument35_Service(IGrid81ForDocument35_TableAccessor set_crud_accessor)
		{
			_crud_accessor = set_crud_accessor;
		}

		/// <inheritdoc/>
		public async Task<IdResponseModel> AddAsync(Grid81ForDocument35 obj_rest)
		{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> AddRangeAsync(IEnumerable<Grid81ForDocument35> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid81ForDocument35_ResponseModel result = new() { IsSuccess = true };
			try
			{
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid81ForDocument35_ResponseListModel result = new() { IsSuccess = true };
			try
			{
		...
		{
			//// TODO: Проверить сгенерированный код
			Grid81ForDocument35_ResponsePaginationModel result = new() { IsSuccess = true };
			try
			{
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateAsync(Grid81ForDocument35 obj_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
		...
		/// <inheritdoc/>
		public async Task<ResponseBaseModel> UpdateRangeAsync(IEnumerable<Grid81ForDocument35> obj_range_rest)
		{
			//// TODO: Проверить сгенерированный код
			ResponseBaseModel result = new() { IsSuccess = true };
			try
