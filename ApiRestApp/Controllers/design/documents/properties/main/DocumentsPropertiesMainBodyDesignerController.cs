...
namespace ApiRestApp.Controllers
{
    ...
    [ApiController]
    public class DocumentsPropertiesMainBodyDesignerController : ControllerBase
    {
        readonly IOptions<ServerConfigModel> _config;
        readonly IDesignerDocumentsPropertiesMainBodyService _documents_properties_service;

        public DocumentsPropertiesMainBodyDesignerController(IOptions<ServerConfigModel> set_config, IDesignerDocumentsPropertiesMainBodyService set_documents_properties_service)
        {
            _config = set_config;
